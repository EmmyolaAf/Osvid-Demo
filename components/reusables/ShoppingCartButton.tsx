...
import WixImage from "@/components/reusables/WixImage";
import {
  useCart,
  useRemoveCartItem,
    ...
    <>
      ...
      <Sheet open={sheetOpen} onOpenChange={setSheetOpen}>
        <SheetContent className="flex flex-col sm:max-w-lg">
          ...
          <div className="flex grow p-4 flex-col space-y-5 overflow-y-auto pt-1">
            ...
            <div className="flex items-center justify-between gap-5">
              <div className="space-y-0.5">
                ...
                <p className="font-bold">
                  {/* @ts-expect-error: subtotal may be undefined at first load, but handled by optional chaining */}
